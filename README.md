...
Can bike-sharing fill the gaps in NYC's subway network? We crunched the data to find out.
📌 Overview
...
🗂️ Data Sources
Source             Description
CityBikes API      Real-time Citi Bike station data — availability, capacity, coordinates
Transitland API    MTA subway stop locations via f-dr5r-nyctsubway feed
...
# 3. Add your Transitland API key in the notebook where API_KEY is set
